...
export APIGEE_LICENSE=$(lpass show --notes apigee | grep "l:" | sed 's/l://')
...
export APIGEE_REPO_USER=$(lpass show --notes apigee | grep 'ru:' | sed 's/ru://')
export APIGEE_REPO_PASS=$(lpass show --notes apigee | grep 'rp:' | sed 's/rp://')
